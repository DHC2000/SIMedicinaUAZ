...
<div class="row justify-content-end mb-3">
  ...
  <div class="col-3">
    <div class="row">
        <div class="col-9">
          <a class="btn btn-outline-info" href="{{url('CargaAcademica')}}"> Carga academica  <i class="fa fa-file-text ml-3" aria-hidden="true"></i></a>
        </div>
        <form class="col-3" action="{{ url('/OfertaEducativa/'.$p->id )}}" method="POST">
          @csrf
          {{method_field('DELETE')}}
